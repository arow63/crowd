				...
				<?php endif;?>
						...
						<?php
							$findReplace = array(
								...
								'##DEMO_URL##' => $this->Html->link('http://dev1products.dev.arow63.com/doku.php?id=crowdfunding-install#how_to','http://dev1products.dev.arow63.com/doku.php?id=crowdfunding-install#how_to', array('target' => '_blank')),
							);
