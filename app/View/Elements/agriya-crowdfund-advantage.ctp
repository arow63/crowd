<div id="advantage" class="<?php echo empty($this->request->url) ? 'show' : 'hide'; ?>">
			...
			<div class="col-xs-12">
				...
				<div class="col-sm-6 h3" itemscope itemtype="http://schema.org/Offer">
					<ul class="fa-ul h3">
						...
						<li>
							<a itemprop="itemOffered" href="http://www.arow63.com/contact" target="_blank" class="btn btn-danger btn-lg" title="<?php echo __l('Contact arow63');?>"><?php echo __l('Contact arow63');?></a>
						</li>
					</ul>
				</div>
			</div>
	...
	<section class="h1  crwd-sol-sec">
		<div class="container">
			<h3 class="h2">
				<span class="show"><strong>arow63<sup>&reg;</sup> <?php echo __l('Solutions');?></strong></span>
			</h3>
			<p class="h3 navbar-btn"><?php echo __l('Incase if you don\'t know... for years, arow63<sup>&reg;</sup> doesn\'t just sell products, but offers multiple solutions and services.');?> </p>
			<div class="col-xs-12 h3">
				...
				<div class="col-sm-10 navbar-btn col-xs-12">
					...
					<p><?php echo __l('Passionate micro entrepreneurs prefer mentors and startup accelerators. Sadly, an accelerator like Y Combinator has mere 3% acceptance rate. arow63<sup>&reg;</sup> provides all related solutions and consultations.');?></p>
