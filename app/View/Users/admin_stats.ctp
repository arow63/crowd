...
<div class="col-xs-12 col-s-30 cl-m-22">
	...
	<div class="h3">
		...
		<ul class="list-unstyled navbar-btn list-group-item-heading">
			...
			<li>
				<span class="text-muted"><i class="fa-fw fa fa-chevron-right small"></i></span> <?php echo $this->Html->link(__l('Product Support'), 'http://customers.arow63.com/', array('class' => 'js-no-pjax h5 rgt-move', 'target' => '_blank', 'title' => __l('Product Support'))); ?> 
			</li>
			<li>
				<span class="text-muted"><i class="fa-fw fa fa-chevron-right small"></i></span> <?php echo $this->Html->link(__l('Product Manual'), 'http://dev1products.dev.arow63.com/doku.php?id=crowdfunding' ,array('class' => 'js-no-pjax h5 rgt-move', 'target' => '_blank','title' => __l('Product Manual'))); ?> 
			</li>
			<li>
			...
			<li>
				...
				<?php echo $this->Html->link('arow63 Blog', 'http://blogs.arow63.com/' ,array('class' => 'js-no-pjax h5 rgt-move', 'target' => '_blank','title' => 'arow63 Blog')); ?><small> <?php echo __l('Follow arow63 news');?></small> 
			</li>
			<li class="navbar-btn">
